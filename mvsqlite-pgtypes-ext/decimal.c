...
/* mvsqlite: changed from INIT1 to INIT3 (extern-declare rather than define
 * sqlite3_api) so this file can be linked into the same shared library as
 * the other vendored ext/misc extensions without a duplicate-symbol error.
 * pgtypes_ext.c owns the one INIT1 definition. Otherwise unmodified from
 * https://sqlite.org/src/dir/ext/misc */
